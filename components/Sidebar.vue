  ...
  <NuxtScrollbar
    ...
    <nav class="flex flex-col gap-2 px-4 mt-10">
      <NuxtLink
        ...
        :key="ml.title"
        class="flex group items-center justify-between px-3 py-2 rounded-lg text-zinc-400 hover:text-primary-50 hover:bg-primary transition cursor-pointer">
        ...
        <nav v-if="showLabels" class="flex flex-col gap-1 mt-5">
          <NuxtLink
            ...
            <div class="flex items-center gap-2">
              <span :class="[l.color]" class="inline-block w-2 h-2 rounded-full"></span>
